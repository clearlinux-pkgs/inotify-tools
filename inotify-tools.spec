...
Version  : 3.21.9.6
Release  : 12
URL      : https://github.com/inotify-tools/inotify-tools/archive/3.21.9.6/inotify-tools-3.21.9.6.tar.gz
Source0  : https://github.com/inotify-tools/inotify-tools/archive/3.21.9.6/inotify-tools-3.21.9.6.tar.gz
...
%prep
%setup -q -n inotify-tools-3.21.9.6
cd %{_builddir}/inotify-tools-3.21.9.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632864539
...
cp %{_builddir}/inotify-tools-3.21.9.6/COPYING %{buildroot}/usr/share/package-licenses/inotify-tools/82b20355021c2d7ebf6bf6e58f8feb7ce35e09dc
%make_install
