...
Version  : 3.22.1.0
Release  : 13
URL      : https://github.com/inotify-tools/inotify-tools/archive/3.22.1.0/inotify-tools-3.22.1.0.tar.gz
Source0  : https://github.com/inotify-tools/inotify-tools/archive/3.22.1.0/inotify-tools-3.22.1.0.tar.gz
...
%prep
%setup -q -n inotify-tools-3.22.1.0
cd %{_builddir}/inotify-tools-3.22.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642637301
...
cp %{_builddir}/inotify-tools-3.22.1.0/COPYING %{buildroot}/usr/share/package-licenses/inotify-tools/82b20355021c2d7ebf6bf6e58f8feb7ce35e09dc
%make_install
