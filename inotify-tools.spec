...
Source0  : https://github.com/inotify-tools/inotify-tools/archive/3.21.9.1/inotify-tools-3.21.9.1.tar.gz
...
%prep
%setup -q -n inotify-tools-3.21.9.1
cd %{_builddir}/inotify-tools-3.21.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632243970
...
cp %{_builddir}/inotify-tools-3.21.9.1/COPYING %{buildroot}/usr/share/package-licenses/inotify-tools/82b20355021c2d7ebf6bf6e58f8feb7ce35e09dc
%make_install
