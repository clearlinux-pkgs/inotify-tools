...
Source0  : https://github.com/inotify-tools/inotify-tools/archive/3.20.11.0/inotify-tools-3.20.11.0.tar.gz
...
%prep
%setup -q -n inotify-tools-3.20.11.0
cd %{_builddir}/inotify-tools-3.20.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605410164
...
cp %{_builddir}/inotify-tools-3.20.11.0/COPYING %{buildroot}/usr/share/package-licenses/inotify-tools/82b20355021c2d7ebf6bf6e58f8feb7ce35e09dc
%make_install
